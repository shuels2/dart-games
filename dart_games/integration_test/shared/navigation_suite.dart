...
// A copy lives at test/shared/navigation_suite.dart and the two must stay
// byte-identical (CLAUDE.md's shared-helper rule; test/meta/ enforces it).
//
// That is not just tidiness here — it is load-bearing. `flutter drive`'s web
...
// so this is invisible until a real UI run. Every other shared helper is
// mirrored, which is why they all resolve.
//
