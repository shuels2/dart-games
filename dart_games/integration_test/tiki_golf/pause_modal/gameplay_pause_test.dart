...
void main() {
  ...
  testWidgets('Test 1: Pause modal appears on game screen when board disconnects',
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_01_appears',
      () async {
  ...
  testWidgets('Test 2: Pause blocks AppBar back arrow on game screen',
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_02_blocks_back',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets(
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_03_blocks_emulator',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets(
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_04_over_remove_darts_modal',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets(
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_05_over_save_game_modal',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets('Test 6: EditScoreDialog auto-closes on dartboard disconnect',
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_06_edit_score_closes',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets('Test 7: Pause dismisses on reconnect (back to normal gameplay)',
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_07_dismisses_gameplay_continues',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
  ...
  testWidgets(
    ...
    await UITestHelpers.runWithFailureScreenshot(
      tester,
      'tiki_golf_pause_modal_gameplay_08_remove_darts_after_reconnect',
      () async {
        await UITestHelpers.resetServerState();
        await setupAndStartGame(tester);
