...
void main() {
  ...
  testWidgets(
    ...
    // Skip remaining darts — with darts on the board, the game waits for
    // DARTS REMOVED. The generous pump gives any skip-scheduled callbacks
    // time to settle before we tap it.
