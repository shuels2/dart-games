...
void main() {
  ...
  testWidgets('Test 4: Pause blocks settings controls',
    ...
    final difficultyDropdown = ElementFinders.getPiratesGridDifficultyDropdown();
    await tester.tap(difficultyDropdown, warnIfMissed: false);
    await PumpSequences.simpleUpdate(tester);
  ...
  testWidgets('Test 5: Pause blocks add player button on menu',
    ...
    final addPlayerButton =
        ElementFinders.getPiratesGridAddPlayerButtonEmptyState();
