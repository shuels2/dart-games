...
void main() {
  ...
  testWidgets('button stays hidden when modal is not shown after resume',
    ...
    // PG's ResumeGameButton has no key — locate it by type, then tap it.
    ...
    // Throw a miss (safe regardless of current game state)
    ...
    final resumeButtonAfter = find.byType(ResumeGameButton);
