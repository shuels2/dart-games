...
void main() {
  ...
  // Verifies gamesPlayed, gamesWon, and gameHistory are updated after a
  ...
  testWidgets('Results: winner and loser stats updated on victory',
    ...
    expect(winner!.gamesPlayed, 1, reason: 'Winner should have gamesPlayed=1');
    expect(winner.gamesWon, 1, reason: 'Winner should have gamesWon=1');
    ...
    expect(loser!.gamesPlayed, 1, reason: 'Loser should have gamesPlayed=1');
    expect(loser.gamesWon, 0, reason: 'Loser should have gamesWon=0');
