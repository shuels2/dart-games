...
start /B "" cmd /C "flutter drive --driver=test_driver/!_RST_DRIVER! --target=!_RST_TARGET! -d chrome --dart-define=SERVER_PORT=!_CAT_PORT! --dart-define=OVERFLOW_TRAP=1 --web-browser-flag=--start-maximized --browser-dimension=1920x1080 >> "!_RST_LOG!" 2>&1"
